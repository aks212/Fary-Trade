            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 space-y-6 text-lg text-muted-foreground">
                <p>
                  ...
                  including ginger, baobab, hibiscus, chili and Egg powder. We are committed
                  to delivering the highest quality organic products while championing
                  sustainable farming practices and empowering local communities.
                </p>
                <p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {divisions.map((division, index) => (
              <ScrollReveal key={division.name} animation="fade-up" delay={index * 100}>
                <div className="p-8 gradient-card rounded-lg shadow-elegant brand-border h-full">
            ...
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {values.map((value, index) => {
                  ...
                  return (
                    <ScrollReveal key={value.title} animation="scale" delay={index * 80}>
